...
public struct PaletteBuilder {
    ...
    @discardableResult
    public func  setTextPrimary(_ textPrimary: UIColor) -> PaletteBuilder {
        var c = self; c.textPrimary = textPrimary
        return self
    }
    @discardableResult
    public func  setTextSecondary(_ textSecondary: UIColor) -> PaletteBuilder {
        var c = self; c.textSecondary = textSecondary
        return self
    }
    @discardableResult
    public func  setTextSuccess(_ textSuccess: UIColor) -> PaletteBuilder {
        var c = self; c.textSuccess = textSuccess
        return self
    }
    @discardableResult
    public func  setTextDanger(_ textDanger: UIColor) -> PaletteBuilder {
        var c = self; c.textDanger = textDanger
        return self
    }
    @discardableResult
    public func  setTextWarning(_ textWarning: UIColor) -> PaletteBuilder {
        var c = self; c.textWarning = textWarning
        return self
    }
    @discardableResult
    public func  setTextInfo(_ textInfo: UIColor) -> PaletteBuilder {
        var c = self; c.textInfo = textInfo
        return self
    }
    @discardableResult
    public func  setTextLight(_ textLight: UIColor) -> PaletteBuilder {
        var c = self; c.textLight = textLight
        return self
    }
    @discardableResult
    public func  setTextDark(_ textDark: UIColor) -> PaletteBuilder {
        var c = self; c.textDark = textDark
        return self
    }
    @discardableResult
    public func  setTextBody(_ textBody: UIColor) -> PaletteBuilder {
        var c = self; c.textBody = textBody
        return self
    }
    @discardableResult
    public func  setTextMuted(_ textMuted: UIColor) -> PaletteBuilder {
        var c = self; c.textMuted = textMuted
        return self
    }
    @discardableResult
    public func  setTextWhite(_ textWhite: UIColor) -> PaletteBuilder {
        var c = self; c.textWhite = textWhite
        return self
    }
    @discardableResult
    public func  setTextBlack50(_ textBlack50: UIColor) -> PaletteBuilder {
        var c = self; c.textBlack50 = textBlack50
        return self
    }
    @discardableResult
    public func  setTextWhite50(_ textWhite50 : UIColor) -> PaletteBuilder {
    ...
    @discardableResult
    public func setPrimaryLink(_ primaryLink: UIColor) -> PaletteBuilder {
        var c = self; c.primaryLink = primaryLink
        return self
    }
    @discardableResult
    public func setSecondaryLink(_ secondaryLink: UIColor) -> PaletteBuilder {
        var c = self; c.secondaryLink = secondaryLink
        return self
    }
    @discardableResult
    public func setSuccessLink(_ successLink: UIColor) -> PaletteBuilder {
        var c = self; c.successLink = successLink
        return self
    }
    @discardableResult
    public func setDangerLink(_ dangerLink: UIColor) -> PaletteBuilder {
        var c = self; c.dangerLink = dangerLink
        return self
    }
    @discardableResult
    public func setWarningLink(_ warningLink: UIColor) -> PaletteBuilder {
        var c = self; c.warningLink = warningLink
        return self
    }
    @discardableResult
    public func setInfoLink(_ infoLink: UIColor) -> PaletteBuilder {
        var c = self; c.infoLink = infoLink
        return self
    }
    @discardableResult
    public func setLightLink(_ lightLink: UIColor) -> PaletteBuilder {
        var c = self; c.lightLink = lightLink
        return self
    }
    @discardableResult
    public func setDarkLink(_ darkLink: UIColor) -> PaletteBuilder {
        var c = self; c.darkLink = darkLink
        return self
    }
    @discardableResult
    public func setMutedLink(_ mutedLink: UIColor) -> PaletteBuilder {
        var c = self; c.mutedLink = mutedLink
        return self
    }
    @discardableResult
    public func setWhiteLink(_ whiteLink: UIColor) -> PaletteBuilder {
    ...
    @discardableResult
    public func setBgPrimary(_ bgPrimary: UIColor) -> PaletteBuilder {
        var c = self; c.bgPrimary = bgPrimary
        return self
    }
    @discardableResult
    public func setBgSecondary(_ bgSecondary: UIColor) -> PaletteBuilder {
        var c = self; c.bgSecondary = bgSecondary
        return self
    }
    @discardableResult
    public func setBgSuccess(_ bgSuccess: UIColor) -> PaletteBuilder {
        var c = self; c.bgSuccess = bgSuccess
        return self
    }
    @discardableResult
    public func setBgDanger(_ bgDanger: UIColor) -> PaletteBuilder {
        var c = self; c.bgDanger = bgDanger
        return self
    }
    @discardableResult
    public func setBgWarning(_ bgWarning: UIColor) -> PaletteBuilder {
        var c = self; c.bgWarning = bgWarning
        return self
    }
    @discardableResult
    public func setBgInfo(_ bgInfo: UIColor) -> PaletteBuilder {
        var c = self; c.bgInfo = bgInfo
        return self
    }
    @discardableResult
    public func setBgLight(_ bgLight: UIColor) -> PaletteBuilder {
        var c = self; c.bgLight = bgLight
        return self
    }
    @discardableResult
    public func setBgDark(_ bgDark: UIColor) -> PaletteBuilder {
        var c = self; c.bgDark = bgDark
        return self
    }
    @discardableResult
    public func setBgWhite(_ bgWhite: UIColor) -> PaletteBuilder {
        var c = self; c.bgWhite = bgWhite
        return self
    }
    @discardableResult
    public func setBgTransparent(_ bgTransparent: UIColor) -> PaletteBuilder {
    ...
    //MARK: BACKGROUND GRADIENT UICOLOR
    @discardableResult
    public func setBgGradientPrimary(_ bgGradientPrimary: UIColor) -> PaletteBuilder {
        var c = self; c.bgGradientPrimary = bgGradientPrimary
        return self
    }
    @discardableResult
    public func setBgGradientSecondary(_ bgGradientSecondary: UIColor) -> PaletteBuilder {
        var c = self; c.bgGradientSecondary = bgGradientSecondary
        return self
    }
    @discardableResult
    public func setBgGradientSuccess(_ bgGradientSuccess: UIColor) -> PaletteBuilder {
        var c = self; c.bgGradientSuccess = bgGradientSuccess
        return self
    }
    @discardableResult
    public func setBgGradientDanger(_ bgGradientDanger: UIColor) -> PaletteBuilder {
        var c = self; c.bgGradientDanger = bgGradientDanger
        return self
    }
    @discardableResult
    public func setBgGradientWarning(_ bgGradientWarning: UIColor) -> PaletteBuilder {
        var c = self; c.bgGradientWarning = bgGradientWarning
        return self
    }
    @discardableResult
    public func setBgGradientInfo(_ bgGradientInfo: UIColor) -> PaletteBuilder {
        var c = self; c.bgGradientInfo = bgGradientInfo
        return self
    }
    @discardableResult
    public func setBgGradientLight(_ bgGradientLight: UIColor) -> PaletteBuilder {
        var c = self; c.bgGradientLight = bgGradientLight
        return self
    }
    @discardableResult
    public func setBgGradientDark(_ bgGradientDark: UIColor) -> PaletteBuilder {
